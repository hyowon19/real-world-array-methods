...
// there is going to be any rain in the next 24 hours. The method you use should return 
// `true` or `false`.
...
// Is it going to rain today?
// Use the appropriate array method to figure out, using the hourly data, whether there 
